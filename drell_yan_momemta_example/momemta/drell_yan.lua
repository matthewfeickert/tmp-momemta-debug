-- Based on https://github.com/MoMEMta/MoMEMta/blob/v1.0.1/examples/WW_fullyleptonic.lua
-- Register inputs
...
-- Loop
    ...
    MatrixElement.WW = {
      ...
      -- matrix element is the name of the matrix element directory
      -- and then the name of the subprocess
      -- so the following is the one for pp_drell_yan/SubProcesses/P1_Sigma_sm_uux_epem
